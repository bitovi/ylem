...
var _canDefineMap = require('can-define/map/map');
var _canDefineMap2 = _interopRequireDefault(_canDefineMap);
function connect(MapToProps, ComponentToConnect) {
    var ConnectedComponent = function (_React$Component) {
        ...
        function ConnectedComponent(props) {
            ...
            this.propsCompute = (0, _canCompute2['default'])(props);
            if (MapToProps.prototype instanceof _canDefineMap2['default']) {
        ...
        _createClass(ConnectedComponent, [
            ...
            },
            {
                ...
                value: function render() {
                    return _react2['default'].createElement(ComponentToConnect, this.state.propsForChild);
                }
            }
        ]);
