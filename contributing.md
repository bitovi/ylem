Thank you for contributing to ylem!

If you need any help setting up a CanJS development environment and fixing ylem bugs, please reach out to us on the [canjs/canjs Gitter channel](https://gitter.im/canjs/canjs) or email (contact@bitovi.com).  We will happily walk you through setting up a the environment, creating a test, and submitting a pull request.

## Reporting Bugs

To report a bug, please visit [GitHub Issues](/bitovi/ylem/issues).
...
1. Navigate to your clone of the ylem repository - `cd /path/to/ylem`
